...
type ExampleServiceClient interface {
	UpdateExample(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *exampleServiceClient) UpdateExample(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
...
type ExampleServiceServer interface {
	UpdateExample(context.Context, *Req) (*Res, error)
...
func (UnimplementedExampleServiceServer) UpdateExample(context.Context, *Req) (*Res, error) {
...
func _ExampleService_UpdateExample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).UpdateExample(ctx, req.(*Req))
	}
